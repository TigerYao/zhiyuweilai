...
package com.zhiyuweilai.tiger.robotbook.widget;
...
//        ThemeUtils.checkAppCompatTheme(context);
        ...
        mTabTextSize = a.getResourceId(R.styleable.TabLayout_textSize,mTabTextAppearance);//ta.getDimensionPixelSize(
                    //android.support.v7.appcompat.R.styleable.TextAppearance_android_textSize, 0);
        mTabTextColors = getResources().getColorStateList(R.color.base_back);
        ...
        mTabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.common_2);
        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.common_20);
    ...
    private void animateToTab(int newPosition) {
        ...
        if (startScrollX != targetScrollX) {
            if (mScrollAnimator == null) {
                mScrollAnimator = new ValueAnimator();//ViewUtils.createAnimator();
        ...
        public TabView(Context context) {
            ...
            if (mTabBackgroundResId != 0) {
                try {
                    ...
                    setBackgroundColor(mTabBackgroundResId);
                }
            }
...
//                    PointerIconCompat.getSystemIcon(getContext(), PointerIconCompat.TYPE_HAND));
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mTextView != null) {
                ...
                final int curMaxLines = mTextView.getMaxLines();//TextViewCompat.getMaxLines(mTextView);
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                ...
                if (mTextView == null) {
                    ...
                    addView(textView);
                    mTextView = textView;
                    mDefaultMaxLines = mTextView.getMaxLines();//TextViewCompat.getMaxLines(mTextView);
                }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimator animator = mIndicatorAnimator = new ValueAnimator();//ViewUtils.createAnimator();
                animator.setInterpolator(new FastOutSlowInInterpolator());//AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
