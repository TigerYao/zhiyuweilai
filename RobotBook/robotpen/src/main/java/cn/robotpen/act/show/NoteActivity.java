...
import com.zhiyuweilai.tiger.robotpen.databinding.ActivityNoteBinding;
...
public class NoteActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteBinding.noteListView.setAdapter(mNoteAdapter);
        noteBinding.noteListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        noteBinding.noteListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
        ...
        noteBinding.addNoteBut.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void checkDeviceConnStatus() {
        ...
        if (null == deviceEntity) {
            ...
            if (SmartPenService.TAG.equals(mPenManage.getSvrTag())) {
                ...
                if (lastDevice == null || TextUtils.isEmpty(lastDevice.getAddress())) {} else {
