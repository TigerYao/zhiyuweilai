...
public class ShowPointActivity extends Activity {
    ...
    ActivityShowPointBinding showPointBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showPointBinding.textview.setText(showPointBinding.textview.getText(), TextView.BufferType.EDITABLE);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case WR_PEN_MOVE:   // move
                    {
                        ...
                        showPointBinding.mainView.dowithWriteMove((float)msg.arg1, (float)msg.arg2, bundle.getFloat("w"));
                        break;
                    }
                    case WR_PEN_DOWN:   // down
                    {
                        Bundle bundle = msg.getData();
                        showPointBinding.mainView.dowithWriteDown((float)msg.arg1, (float)msg.arg2, bundle.getFloat("w"));
                        break;
                    }
                    case WR_PEN_UP:   // up
                        showPointBinding.mainView.dowithWriteUp();
                        break;
                    case WR_RANGE_STRING:   // 识别结果
                    // showPointBinding.mainView.dowithWriteText(msg.obj.toString());
                    {

                        String sReg = GetRegStext(msg.obj.toString());
                        Editable text = (Editable)showPointBinding.textview.getText();
                        text.append(sReg);
                        showPointBinding.textview.setText(text);;// myEdit.setText();
                    }
                        break;
                    default:
                        break;
